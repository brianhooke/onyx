MODULE Brian
    !*******************************************************************
    ! ARCHIVED MODULE - NOT IN ACTIVE USE
    ! This module contains commented-out development/test code for
    ! plotting and drawing operations. It is retained for reference only.
    !*******************************************************************
